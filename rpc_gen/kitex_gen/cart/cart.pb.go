...
func (x *GetItem) GetProductId() uint32 {
	if x != nil {
		return x.ProductId
	}
	return 0
...
func (x *GetItem) GetQuantity() uint32 {
	if x != nil {
		return x.Quantity
	}
	return 0
...
type AddItemReq struct {
	...
	Item   *GetItem `protobuf:"bytes,2,opt,name=item,proto3" json:"item,omitempty"`
}
...
func (x *AddItemReq) GetItem() *GetItem {
	if x != nil {
		return x.Item
	}
	return nil
...
type GetCartResp struct {
	...
	Items []*GetItem `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *GetCartResp) GetItems() []*GetItem {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_cart_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x22, 0x44, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x1d, 0x0a,
	...
	,
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x0f, 0x0a, 0x0d, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x43, 0x61,
	0x72, 0x74, 0x52, 0x65, 0x73, 0x70, 0x32, 0xa9, 0x01, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x53,
	...
	0x22, 0x00, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x6f, 0x6d, 0x61, 0x6c, 0x6c, 0x2f, 0x72, 0x70, 0x63,
...
var file_cart_proto_depIdxs = []int32{
	0, // 0: cart.AddItemReq.item:type_name -> cart.GetItem
	0, // 1: cart.GetCartResp.items:type_name -> cart.GetItem
