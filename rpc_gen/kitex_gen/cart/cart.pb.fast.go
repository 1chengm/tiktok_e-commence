...
func (x *GetItem) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
...
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_GetItem[number], err)
}

func (x *GetItem) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.ProductId, offset, err = fastpb.ReadUint32(buf, _type)
	return offset, err
}

func (x *GetItem) fastReadField2(buf []byte, _type int8) (offset int, err error) {
...
func (x *GetItem) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
...
func (x *GetItem) fastWriteField1(buf []byte) (offset int) {
	if x.ProductId == 0 {
		return offset
	}
...
func (x *GetItem) fastWriteField2(buf []byte) (offset int) {
	if x.Quantity == 0 {
		return offset
	}
...
func (x *GetItem) sizeField1() (n int) {
	if x.ProductId == 0 {
		return n
	}
...
func (x *GetItem) sizeField2() (n int) {
	if x.Quantity == 0 {
		return n
	}
...
var fieldIDToName_GetItem = map[int32]string{
	1: "ProductId",
	2: "Quantity",
}
